 ...
 * Todos are persisted to localStorage under 'todos'.
 */
export const TodoProvider = ({ children }) => {
  ...
  const value = useMemo(
    ...
    [todos, processedTodos, stats, searchQuery, activeFilter, sortBy, addTodo, updateTodo, deleteTodo, toggleStatus, toast, showToast]
  );
