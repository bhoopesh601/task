...
/**
 * Navbar — Left sidebar navigation on desktop.
 * On mobile, it splits into a top sticky header and a bottom navigation bar.
 */
    ...
    <>
      ...
      <div className="mobile-top-header">
        ...
        <div className="mobile-header-actions">
          <ThemeToggle />
          <button className="mobile-logout-btn" onClick={logout} aria-label="Log out">
      ...
      <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`} id="main-navbar">
        ...
        {/* Desktop Bottom Area (Hidden on Mobile) */}
        <div className="sidebar-bottom desktop-bottom">
          <ThemeToggle />
